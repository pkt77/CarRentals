...

{
    if(flag==1)
    {
        ...
        else
        {
            ...
            customerInfoObject.FirstName=customerFirstName;
            customerInfoObject.LastName=customerLastName;
            customerInfoObject.DateOfBirth=customerDOB;
            customerInfoObject.PhoneNumber=customerPhone;
            customerInfoObject.EmailAddress=customerEmail;

            console.log(customerInfoObject.FirstName);
            console.log(customerInfoObject.LastName);
            console.log(customerInfoObject.DateOfBirth);
            console.log(customerInfoObject.PhoneNumber);
            console.log(customerInfoObject.EmailAddress);
...
function loadThirdPage()
{
    ...
    if(flag==2)
    {
       ...
       else
       {
            ...
            customerInfoObject.StreetName=customerStreetName;
            customerInfoObject.CityName=customerCityName;
            customerInfoObject.StateName=customerStateName;
            customerInfoObject.PostalCode=customerPostalCode;
            ...
            console.log(customerInfoObject.PhoneNumber);
            console.log(customerInfoObject.EmailAddress);
            console.log(customerInfoObject.StreetName);
            console.log(customerInfoObject.CityName);
            console.log(customerInfoObject.StateName);
            console.log(customerInfoObject.PostalCode);
...
function loadFourthPage()
{
    if(flag==3)
    {
       ...
       {
            flag++;
            customerInfoObject.LicenseNumber=customerLicensetNumber;
            customerInfoObject.IssuingAuthority=customerAuthority;
            customerInfoObject.ExpireDate=customerExpireDate;
            ...
            console.log(customerInfoObject.StateName);
            console.log(customerInfoObject.PostalCode);
            console.log(customerInfoObject.LicenseNumber);
            console.log(customerInfoObject.IssuingAuthority);
            console.log(customerInfoObject.ExpireDate);
...
function loadLastPage()
{
    ...
    {
            customerInfoObject.UserName=customerUserName;
            customerInfoObject.Password=customerPassword;
            ...
            console.log(customerInfoObject.IssuingAuthority);
            console.log(customerInfoObject.ExpireDate);
            console.log(customerInfoObject.UserName);
            console.log(customerInfoObject.Password);
...
function sendData()
{
    ...
    let temp=JSON.stringify(customerInfoObject);
    xhttp.send(temp);
